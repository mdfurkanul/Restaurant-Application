...
{
    public partial class frmMostPopular : Form
    {
        ...
        private void menuList(int cat)
        {
            ...
            try
            {
                string query = "SELECT Id,Name,Description,Price,CookingTime,Image FROM menu where catalog='" + cat + "' order by totalorder desc;";
        ...
        private void btnAddFavorite_Click(object sender, EventArgs e)
        {
            if (getLogInCode()==1){
                if (Conflict_Check())
                {
                    MessageBox.Show("Already added to favourite list");
                }
                else {
                    string connStr = "server=localhost;user=root;database=ra;password=;";
                    MySqlConnection conn = new MySqlConnection(connStr);

                    string sql = "insert into favourite (food_id,c_id) values ('" + food_id.Text + "','" + getEmail()+"')";
        ...
        private void show_all_menu()
        {
            ...
            try
            {
                string query = "SELECT Id,Name,Description,Price,CookingTime,Image FROM menu order by totalorder desc;";
                MySqlConnection con = new MySqlConnection(MyConString);
                con.Open();
                MySqlCommand command = new MySqlCommand(query, con);
                MySqlDataAdapter dataAdp = new MySqlDataAdapter(command);
        ...
        {
            btnAll.BackColor = Color.OrangeRed;
            menuList(1);
        }

        private void btnFried_Click(object sender, EventArgs e)
        {
            menuList(2);
        }

        private void btnSweetSour_Click(object sender, EventArgs e)
        {
            menuList(3);
        }
        ...
        private void btnLoMein_Click(object sender, EventArgs e)
        {
            menuList(6);
        }
        ...
        private void btnCaribean_Click(object sender, EventArgs e)
        {
            menuList(10);
        }
        ...
        private void search_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                query = "SELECT Id,Name,Description,Price,CookingTime,Image FROM menu where Name like '%" + search.Text + "%' order by totalorder desc;";
            }
