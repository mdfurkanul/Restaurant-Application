...
{
    public partial class frmTableEmpty : Form
    {
        ...
        private void panel1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Table already free..");
            }
            else {
        ...
        {
                string connStr = "server=localhost;user=root;database=ra;password=;";
                string sql = "UPDATE tablebookingstatus SET Status='0',userID='None' where tableNo='" + p + "' ";
                ...
                try
                {
                    ...
                    MessageBox.Show("Relase the table successfully...");
                }
                catch (Exception e)
                {
