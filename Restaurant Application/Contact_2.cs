...
{
    public partial class frmContact_2 : Form
    {
        ...
        private void snd_Click(object sender, EventArgs e)
        {
            ...
            else if (sub.Text.Equals(""))
            {
                MessageBox.Show("Subject is not empty!");
            }
            else if (message.Text.Equals(""))
            {
                MessageBox.Show("Message is not empty!");
            }
            else{
                string body = "Dear,\n My name is: "+name.Text+"\n And Email is: "+email.Text+
                              "\n"+message.Text;
                Mailer_func m = new Mailer_func();
                m.SendEmail_From(sub.Text, body);
                MessageBox.Show("Thank you for giving feedback!");
            }
