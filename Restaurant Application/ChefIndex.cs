...
{
    public partial class frmChefIndex : Form
    {
        ...
        private void pnlDiscount_Click(object sender, EventArgs e)
        {
            pnlTable.BackColor = Color.MediumSpringGreen;
            StopTimerAll();
            frmOrderReceive n = new frmOrderReceive();
            n.Show();
            closeCount = 0;
            closeFlag = true;
            frmClose.Enabled = true;
        ...
        private void pnlTable_Click(object sender, EventArgs e)
        {
            pnlTable.BackColor = Color.MediumSpringGreen;
            StopTimerAll();
            frmTableEmpty n = new frmTableEmpty();
            n.Show();
            closeCount = 0;
            closeFlag = true;
            frmClose.Enabled = true;
        ...
        private void pnlContact_Click(object sender, EventArgs e)
        {
            pnlTable.BackColor = Color.MediumSpringGreen;
            StopTimerAll();
            frmContact_2 n = new frmContact_2();
            n.Show();
            closeCount = 0;
            closeFlag = true;
            frmClose.Enabled = true;
