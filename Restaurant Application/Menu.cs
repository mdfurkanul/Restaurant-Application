...
namespace Restaurant_Application
{
    public partial class frmMenu : Form
    {
        ...
        private void menuList(int cat)
        {
            ...
            try
            {
                string query = "SELECT Id,Name,Description,Price,CookingTime,Image FROM menu where catalog='"+cat+"';";
        ...
        private void show_all_menu()
        {
            ...
            try
            {
                string query = "SELECT Id,Name,Description,Price,CookingTime,Image FROM menu;";
                MySqlConnection con = new MySqlConnection(MyConString);
                con.Open();
                MySqlCommand command = new MySqlCommand(query, con);
                MySqlDataAdapter dataAdp = new MySqlDataAdapter(command);
        ...
        private void search_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                query = "SELECT Id,Name,Description,Price,CookingTime,Image FROM menu where Name like '%" + search.Text + "%';";
            }
